...
import { enviarMensagemDocumentoService, listarMensagensDocumentoService, DocumentMessage } from "@/service/comentario"
        ...
        <Dialog open={aberto} onOpenChange={setAberto}>
            ...
            <DialogContent onCloseAutoFocus={() => setMensagem("")} className="w-1/2 flex flex-col max-h-[90vh]">
                ...
                <div className="flex flex-col gap-4 py-2 flex-1 overflow-hidden">
                    ...
                    <div className="flex flex-col gap-1 bg-yellow-50 p-3 rounded-md border border-yellow-200 text-sm shrink-0">
                        <p className="font-semibold mb-1 text-yellow-800 flex items-center gap-2">
                            <span className="text-lg bg-yellow-200 px-1 rounded">IA</span> <span className="text-[20px]">Feedback da Avaliação:</span>
                        </p>

                        <p className="text-gray-700 text-[18px] max-h-24 overflow-y-auto">
                    ...
                    <div className="flex items-center gap-2 text-sm font-semibold text-gray-700 mt-2">
                        ...
                        <span className="text-lg">Comentários sobre este item</span>
                    </div>

                    {/* Lista de Mensagens (Scrollável) */}
                    <ScrollArea className="flex-1 bg-gray-50 rounded-md border p-4 max-h-60 overflow-y-scroll">
                        {carregando ? (
                    ...
                    <div className="flex flex-col gap-2 shrink-0 pt-2">
                        ...
                        <div className="flex justify-end">
                            <Button
                                ...
                                size="sm"
                                className="gap-2 hover:cursor-pointer bg-verde hover:bg-verde"
                            >

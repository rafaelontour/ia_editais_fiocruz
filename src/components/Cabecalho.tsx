...
export default function Cabecalho() {
  ...
  return (
    <header
      className="w-full bg-[#F5F5F5] px-4 flex justify-between items-center"
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <p className="flex items-center">
                ...
                <span className={`${usuario ? "opacity-100" : "opacity-0"}`}>
            ...
            >
              Versão da plataforma: 3.0.0{/* { versaoPlataforma } */}
            </motion.div>
          </div>
        )}
      </div>

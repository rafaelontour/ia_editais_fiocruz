...
export async function enviarMensagemDocumentoService(docId: string, payload: CreateMessagePayload) {
...
export async function listarMensagensDocumentoService(docId: string, filtros?: MessageFilter): Promise<{ messages: DocumentMessage[] } | null> {

        ...
        <div className="flex flex-col">
            <div className="bg-[url(/backgroundImg.png)] bg-repeat bg-contain px-12 pb-4 rounded-md w-full flex justify-center items-center gap-10 flex-col">
                ...
                <div className="flex text-xl gap-4 font-medium">
                    <button className="text-vermelho border-vermelho border-solid border-2 px-8 py-2 rounded-md">Base de conhecimento</button>
                    <button className="text-branco bg-vermelho px-6  rounded-md ">Análise de editais</button>
                </div>

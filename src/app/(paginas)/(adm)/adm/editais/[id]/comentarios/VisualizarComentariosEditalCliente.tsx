...
export default function VisualizarComentariosEditalCliente({
  idEdital,
  urlBase,
}: VisualizarComentariosEdital) {
  const [comentariosEdital, setComentariosEdital] = useState<
    Comentario[] | undefined
  >(undefined);
  const [enderecoArquivo, setEnderecoArquivo] = useState<string | undefined>(
    undefined,
  );
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-108px)]">
      ...
      <ResizablePanelGroup
        ...
        className="flex gap-6 h-[calc(100vh-108px)]"
      >

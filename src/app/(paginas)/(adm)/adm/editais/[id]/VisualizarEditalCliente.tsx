...
export default function VisualizarEditalCliente({
  edital,
  editalArquivo,
  urlBase,
  resumoIA,
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-108px)] gap-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center flex-row gap-4 w-full justify-between">
          ...
          >
            <span>
              {edital?.history &&
                verificarStatusEdital(edital?.history[0].status)}
            </span>
            {iconeParaStatusDoEdital(
        ...
        <div
          className={`flex items-center gap-2 ${enviouAnaliseOuConcluido && "cursor-not-allowed"}`}
        >
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button
                      ...
                      className="hover:cursor-pointer text-[16px] text-white bg-vermelho hover:bg-red-900 data-[disabled=true]:cursor-not-allowed data-[disabled=true]:opacity-60 ml-2.5"
                    >
                      Rejeitar
                    </Button>
                  </DialogTrigger>
                  ...
                  <DialogContent className="max-w-[600px]">
                    ...
                    <DialogDescription>
                      <p className="text-[16px]">
                        Por favor, escreva abaixo uma justificativa para a
                        rejeição do edital
                      </p>
                    </DialogDescription>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          if (
                            ...
                            toast.warning(
                              "Escreva uma justificativa para rejeitar o edital!",
                            );
                            return;
                          }

...
import { ArrowUpDown, Calendar, Loader2, PencilLine, Plus, Search, Trash, X } from "lucide-react";
...
export default function Taxonomias({ id }: { id: string }) {
    ...
    const [tituloTaxonomia, setTituloTaxonomia] = useState<string | undefined>("");
    const [descricaoTaxonomia, setDescricaoTaxonomia] = useState<string | undefined>("");
    ...
    useEffect(() => {
        ...
        const filtradas = filtrarTaxonomiasPorNome(termo);
        setTaxFiltradas(filtradas || []);
    }, [tax]);
        ...
        <div className="flex flex-col flex-1">
            ...
            <div className="flex h-[70vh] gap-3 relative pb-10">
                <div className="flex flex-col w-1/2 overflow-y-auto">
                    ...
                    <div className="flex sticky bg-white top-0 items-center gap-5 w-full px-0.5 pb-4">
                        <div className="flex w-full relative">
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        const taxsFiltradas = filtrarTaxonomiasPorNome(e.target.value);

                                        if (taxsFiltradas !== undefined) {
